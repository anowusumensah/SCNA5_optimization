close all; clear; clc;
    ...
    odeFun = @zhengParam;
    global Erev;
    Erev = 4.33322; % Reversal Potential From Paper
    global fac;
    fac = 100;
    global INa_Curr;  
    INa_Curr = @INa_Curr;
    ...
    % % default_valsF1 = textread('optimizedG1481V.txt'); % % Default Parameters
    load('MahajZheng-PSW-295-G1481V-Score-12347-Pers-0.425.mat')
    default_valsF1 = valsF1';
    default_fvalF1 = fun(default_valsF1); 
    param = default_valsF1;
    curDur = pwd;
   fileFMin=curDur + "/MahajZheng-Fmin-295-G1481V-Score-12347-" + num2str(persVal) + ".mat";
   if ~exist(fileFMin,'file')
        ...
        start=load(fileFMin); %% Just load it
        valsFm = start.valsFm;
        fvalFm = start.fvalFm;
    ...
    % % optsPSO.MinNeighborsFraction = 1;
    for k = 1:3 % %  Perform 3 different iterations 
	    filePSW="MahajZheng-PSW-295-G1481V-Score-12347-iter-" + num2str(k) + "-" +  num2str(persVal) + ".mat";
	    try
