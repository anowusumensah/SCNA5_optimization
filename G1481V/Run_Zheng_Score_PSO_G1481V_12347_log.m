close all; clear; clc;
    ...
    % % Vhalf_EXP = -33.5;
    % % K_EXP = -14.2;
    % % Y_EXP = 1./(1 + exp((accleart(:,1) - Vhalf_EXP)/K_EXP));
    ...
    default_valsF1 = textread('Vent_G1481V.txt'); % % Default Parameters
    ...
    fileFmin="MahajZheng-Fmin-295-G1481V-Score-12347-Pers-log-" + num2str(persVal) + ".mat";
    ...
    % % optsPSO.MinNeighborsFraction = 1;
    for k = 1:3
 	    filePSW="MahajZheng-PSW-295-G1481V-Score-12347-Pers-iter-log-" + num2str(k) + "-" + num2str(persVal) + ".mat";
	    try
